...
// v413：潛水課程（依老闆提供內容）
// v424t：新增「體驗潛水（免證照）」「持證精進·Fun Dive 練功」兩張卡 — 價格/時長待老闆確認
const COURSES = [
  {
...
const SPOTS = [
  ...
  { n: "05", bg: "bg-coral", zh: "萊萊鶯歌石", en: "Lailai Yingge Rock", level: "初級", d: "位於三貂角／馬崗一帶，海蝕平台發達、太平洋暖流經過，魚類繁盛；石洞常藏龍蝦，並有海蛇、章魚與大型魚群。", tags: ["普遍不深 · 無強流", "Fun Dive"] },
...
const LVL_CLASS: Record<string, string> = { "初級": "easy", "進階": "mid", "挑戰": "hard" };
