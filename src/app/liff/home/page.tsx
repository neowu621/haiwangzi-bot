        ...
        <section style={{ position: "relative", overflow: "hidden", background: "linear-gradient(180deg,#0b4f86 0%,#04294c 60%,#02152a 100%)", padding: "18px 16px 20px" }}>
          ...
          <div style={{ position: "relative", zIndex: 1 }}>
            ...
            <div style={{ display: "flex", alignItems: "stretch", gap: 12 }}>
              <h1 style={{ flex: 1, minWidth: 0, margin: 0, fontSize: 26, fontWeight: 900, lineHeight: 1.16, whiteSpace: "nowrap", textShadow: "0 6px 24px rgba(0,0,0,.5)" }}>
                潛入大海<br />看見<span style={{ color: "#66d8f6" }}>另一個世界</span>
              </h1>
              <div style={{ flex: "none", width: 104, alignSelf: "stretch", position: "relative", borderRadius: 14, overflow: "hidden", border: "1px solid rgba(102,216,246,.4)", boxShadow: "0 12px 30px -12px rgba(2,21,42,.8)", background: "#0a3050" }}>
                {/* eslint-disable-next-line @next/next/no-img-element */}
                <img src="/home/src-hero-diver.webp" alt="海王子教練 汪汪" loading="eager" fetchPriority="high" decoding="async" style={{ position: "absolute", inset: 0, width: "100%", height: "100%", objectFit: "cover", objectPosition: "center 20%" }} />
                <span style={{ position: "absolute", bottom: 7, left: "50%", transform: "translateX(-50%)", background: "rgba(2,21,42,.8)", border: "1px solid rgba(102,216,246,.35)", color: "#bcd9ec", fontSize: 9, fontWeight: 800, padding: "2px 9px", borderRadius: 999, whiteSpace: "nowrap" }}>汪汪</span>
              </div>
            </div>
