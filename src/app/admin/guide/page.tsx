          ...
          <ul className="list-disc space-y-1 pl-5 text-xs">
            <li><b>兩個潛水次數要分清楚：</b>
              <ul className="list-disc space-y-0.5 pl-5 mt-1">
                <li><b>「海王子累積氣瓶數」</b>＝在海王子實際下水、<b>教練現場按「到場」才 +該場氣瓶數</b>，無法自填。<b>VIP 升等只看這個</b>（防自填灌水）。</li>
                <li><b>個人資料的「潛水次數」</b>＝會員<b>自填的總經驗</b>（含在別家累積），僅供教練了解經驗、<b>不影響 VIP</b>。下單時會請會員再次確認/更新潛次 + 證照 + 號碼。</li>
              </ul>
            </li>
            <li>等級：🦐LV1(0) → 🦞LV2(21) → 🐢LV3(51) → 🪼LV4(101) → 🐋LV5(201)。每升一級自動發升等獎勵抵用金。</li>
            <li>進場 / 預約前若缺電話 / Email 會跳「補資料」視窗，Email 需點驗證信完成驗證才算數。</li>
            <li><b>我的預約分類：</b>「即將進行的預約」＝未來活動；「已結束」＝活動結束(有參加) + 活動取消(未參加)。</li>
          </ul>
        </Section>
