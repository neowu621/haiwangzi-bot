  ...
  return (
    <div className="fv-wrap">
      ...
      <style>{`
        ...
        .fv-card{flex:none;width:260px;display:flex;flex-direction:column;border-radius:14px;overflow:hidden;text-decoration:none;
        ...
        @media(max-width:520px){.fv-card{width:210px;}}
