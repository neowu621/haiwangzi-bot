  ...
  return (
    <div style={{ minHeight: "100vh", background: "#eef3f6", color: "#1A2330", fontFamily: "'Noto Sans TC','PingFang TC','Microsoft JhengHei',sans-serif" }}>
      <header style={{ background: "#0A2342", color: "#fff" }}>
        <div style={{ maxWidth: 820, margin: "0 auto", padding: "16px 20px", display: "flex", alignItems: "center", gap: 10 }}>
      ...
      <main style={{ maxWidth: 820, margin: "0 auto", padding: "32px 22px 64px" }}>
        ...
        <div style={{ textAlign: "center", marginTop: 22 }}>
          <Link href="/dtest" style={{ color: "#0a8f86", fontWeight: 700, fontSize: 14, textDecoration: "none" }}>← 返回會員預約</Link>
        </div>
      </main>
    </div>
  );
